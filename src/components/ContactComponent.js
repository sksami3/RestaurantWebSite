...
import { Col, FormGroup, Form, Input, Label, Button, FormFeedback } from 'reactstrap';
...
class Contact extends Component {
    ...
    handleInputChange(event){
        ...
        const value = targer.type === 'checkbox' ? targer.checked : targer.value;
        const name = targer.name;
