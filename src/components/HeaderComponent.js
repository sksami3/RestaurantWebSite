...
import { Navbar, NavbarBrand, Jumbotron, NavbarToggler, Collapse, Nav, NavItem, Button, Modal, ModalHeader, ModalBody, FormGroup, Label, Input, Form } from 'reactstrap';
                    ...
                    <div className="container">
                        ...
                        <Collapse isOpen={this.state.isNavOpen} navbar>
                            <Nav navbar>
                                ...
                                <Nav className="ms-auto !important" navbar>
                                    <NavItem>
